...
public class SanityWidgetTest extends WrapperViewGroup {
    ...
    public SanityWidgetTest(Context context) {
        ...
        UIButtonFilled buttonFilled = new UIButtonFilled(
                new Component("Button0", 0.85f, 0.25f, 0.15f, 0.1f), true
        );
        ...
        UIButtonSwitch buttonSwitch = new UIButtonSwitch(
                new Component("BUTTON1", 0.85f, 0.5f, 0.15f, 0.1f)
        );


        UIButtonList buttonList = new UIButtonList(new Component("BUTTON2", 0.85f, 0.75f, 0.15f, 0.1f));
        ...
        bar.addEvent((OnClick) pointers -> bar.setRotation(bar.desc()[2] + TrigTable.HALF_PI));
        ...
        add(buttonFilled, buttonSwitch, buttonList, bar, calendar, tracker);
    }
