...
public class UIButtonList extends WrapperView {
    ...
    public UIButtonList(View view) {
        ...
        viewLeft.addEvent((OnClick) pointers -> show(index - 1));
        ...
        viewRight.addEvent((OnClick) pointers -> show(index + 1));
    ...
    public interface OnNext extends Event<String> {
    }
    ...
    public interface OnPrevious extends Event<String> {
    }
    ...
    public void show(int i) {
        if (!list.isEmpty()) {
            ...
            if (i < index) updateEvent(OnPrevious.class, str);
            if (i > index) updateEvent(OnNext.class, str);
