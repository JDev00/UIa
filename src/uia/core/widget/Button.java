...
public class Button extends Widget {
    ...
    public Button(Context context, float x, float y, float width, float height) {
        ...
        super.buildShape(s -> Figure.buildOval(s, 25), false);
    ...
    protected void draw(Graphic graphic) {
        ...
        textView.setDimension(width, height);
        textView.setPosition(
                xTranslate * (textView.width() + width),
                yTranslate * (textView.getTextHeight() + height));
    }
