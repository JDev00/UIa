...
/**
 * Figure is used to easily build standard shapes
 */
...
public class Figure {
     ...
     * @param vertices the number of vertices
     * @param a        the radius between [0,1] used to round the upper-left corner
     * @param b        the radius between [0,1] used to round the center-right corner
     * @param c        the radius between [0,1] used to round the lower-left corner
     */

    public static Shape triangle(Shape shape, int vertices, float a, float b, float c) {
        shape = checkValidity(shape, 3);
        shape.clear();
        ...
        for (int i = 0; i <= vertices; i++) {
            ...
            shape.addVertex(1 - bx + bx * cos(an), -by * sin(an));
        }
    ...
    public static Shape oval(Shape shape, int vertices) {
        shape = checkValidity(shape, vertices + 1);
        shape.clear();
    ...
    public static Shape pause(Shape shape) {
    ...
    public static Shape arrow(Shape shape) {
        shape = checkValidity(shape, 4);
        shape.clear();
        shape.addVertices(
                -1, -1,
    ...
    public static Shape arrow2(Shape shape) {
        shape = checkValidity(shape, 4);
        shape.clear();
        shape.addVertices(
                -0.15f, -1f,
    ...
    public static Shape plus(Shape shape, float thickness) {
    ...
    public static Shape delete(Shape shape, float thickness) {
        float th = Utils.constrain(thickness, 0, 1f);
