...
public class Test1 extends WrapperViewGroup {
    ...
    public Test1(Context context) {
        ...
        buttonListUI.setText("1\n1", "2", "3", "4", "5");


        ViewText text = new ComponentText(new Component("Text", 0.25f, 0.5f, 0.45f, 0.33f));
        text.setAlign(ViewText.AlignX.CENTER);
        ...
        group.add(text, buttonSwitchUI, buttonListUI, buttonFilledUI);
        group.setClip(false);
