...
public class GraphicAWT implements Graphic {
    ...
    public void setFont(Font font) {
        ...
        if (!font.isBuilt() || !(font.getNative() instanceof java.awt.Font)) {
    ...
    public void setPaint(Paint p) {
        ...
        if (!p.isBuilt() || !(p.getNativeColor() instanceof java.awt.Paint)) {
            p.setNative(
    ...
    public void drawImage(Image img, float x, float y, float width, float height, float rotation) {
        if (!img.isBuilt() || !(img.getNative() instanceof java.awt.Image)) {
